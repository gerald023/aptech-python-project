...
urlpatterns = [
    ...
    # path("dishes/<int:pk>/add-to-menu/", dish_add_to_menu, name="dish-add-to-menu"),
    # path("dishes/<int:pk>/remove-from-menu/", dish_remove_from_menu, name="dish-remove-from-menu"),
    ...
    path('menus/by-restaurant/<int:restaurant_id>/', by_restaurant, name='menus-by-restaurant'),
